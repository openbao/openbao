...
As of Vault 1.6, all databases support dynamic roles and static roles. All plugins support rotating
...
fields. This is necessary for some alternate connection string formats. See the
[databases secrets engine API
docs](/vault/api-docs/secret/databases#common-fields) and reference individual
