...
func bindBackend[Req, Resp kmiplib.OperationPayload](b logical.Backend, fn func(context.Context, logical.Backend, Req) (Resp, error)) kmipserver.OperationHandler {
...
func registerHandlers(executor *kmipserver.BatchExecutor, b logical.Backend) {
	executor.Route(kmiplib.OperationRegister, bindBackend(b, handleRegister))
}
