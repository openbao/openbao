...
If you're new to OpenBao, you may want to pick up with [Your First Secret](/tutorials/getting-started/getting-started-first-secret) in our getting started guide.
