...
- Wrapped Accessor: If the wrapped response is an authentication response
  containing a OpenBao token, this is the value of the wrapped token's accessor.
...
function](https://godoc.org/github.com/lf-edge/openbao/api#Client.SetWrappingLookupFunc)
