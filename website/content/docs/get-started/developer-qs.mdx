...
---
<!-- TODO: clarify what to do with no longer working code examples -->
...
[Go](https://pkg.go.dev/github.com/lf-edge/openbao/api) (official) client library:

```shell-session
$ go get github.com/lf-edge/openbao/api
```
...
```go
import vault "github.com/lf-edge/openbao/api"
```
