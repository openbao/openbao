...
The Password policies [API docs can be found here](../api/system/policies-password.mdx).
...
![OpenBao Password Policy Flow](/img/openbao-password-policy-flow.svg)
...
![Password Policy Performance](/img/openbao-password-policy-performance.svg)
...
![Chance of Generating a Good Password - 1](/img/openbao-password-policy-chance.svg)
...
[`generate`](../api/system/policies-password.mdx) endpoint to see how much time the policy takes to
produce passwords.
...
See the [API docs](../api/system/policies-password.mdx) for examples of the commands to save/read/etc.
password policies
