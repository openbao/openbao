...
1. The import path for version 4 is `github.com/lf-edge/openbao/sdk/database/dbplugin`
   whereas the import path for version 5 is `github.com/lf-edge/openbao/sdk/database/dbplugin/v5`
...
1. Change the import path from `github.com/lf-edge/openbao/sdk/database/dbplugin` to
   `github.com/lf-edge/openbao/sdk/database/dbplugin/v5`. The package name is the same, so any
