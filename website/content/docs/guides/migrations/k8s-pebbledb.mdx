        ...
        - name: migrate
          ...
          args:
            - |
              ...
              # Remove old "file" backend files
              rm -rf /openbao/data/core /openbao/data/logical /openbao/data/sys
              echo "File storage backend files have been deleted successfully."
          volumeMounts:
...
File storage backend files have been deleted successfully.
```
