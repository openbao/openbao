...
[client count](/docs/concepts/client-count) report
...
> Refer to the [OpenBao Usage Metrics](/tutorials/monitoring/usage-metrics) tutorial to learn more about usage metrics,
...
```shell-session
$ bao operator usage -start-time=2020-01 -end-time=2020-01
