...
| ------- | ------------------------ | -------------- | --------------- | --------------------- | --------- |
| Setting properties on `{{hash}}` objects in Handlebars templates | [Link](hash-helper-properties.mdx) | TBD | TBD | Refactor to use component properties, tracked objects, or individual property bindings instead of mutating hash objects. See deprecation guide for detailed examples. | [Deprecation guide](hash-helper-properties.mdx) |
