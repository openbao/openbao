...
with OpenBao's [Integrated Storage backend](../../../internals/integrated-storage.mdx).

## Get cluster state

This endpoint is used to retrieve the raft cluster state. See the [docs page](../../../commands/operator/raft.mdx#autopilot-state) for a description of the output.
