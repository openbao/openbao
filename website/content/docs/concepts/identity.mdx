...
Groups](/tutorials/auth-methods/identity) tutorial to learn how OpenBao supports mutliple authentication methods and enables the same authentication method to be used with different mount paths.
