...
description: The `/sys/ha-status` endpoint is used to check the HA status of a OpenBao cluster.
---

# `/sys/ha-status`

The `/sys/ha-status` endpoint is used to check the HA status of a OpenBao cluster.
