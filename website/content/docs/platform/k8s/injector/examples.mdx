...
Agent configuration settings, [see the Agent documentation](/docs/agent-and-proxy/agent/template#vault-agent-templates).
...
(`cert.key`) generated by [Vault's PKI Secrets Engine](/docs/secrets/pki).
