...
> **Requirement:** *When a direct [commit](https://baseline.openssf.org/versions/2025-02-25#commit) is attempted on the project's [primary branch](https://baseline.openssf.org/versions/2025-02-25#primary-branch), an enforcement mechanism MUST prevent the [change](https://baseline.openssf.org/versions/2025-02-25#change) from being applied.*

The `main` branch is protected across all repositories to prevent unintended or unreviewed commits. These [protection settings](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-protected-branches/about-protected-branches) include:
