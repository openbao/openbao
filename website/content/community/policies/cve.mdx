...
Embargoed patches will not be disclosed outside of the organizations of Dev
WG voting members. These organizations may run patches on their own
infrastructure, e.g., for internal or publicly accessible instances, but may
not ship patch sources to third-party organizations. These organizations may
ship patched binaries to third-party organizations with which they have a
strict NDA with but should not reveal sensitive details of the vulnerabilities
to them until after they're publicly disclosed. Our intention is to have
greater confidence in CVE patches affecting hard-to-test or proprietary
configurations ahead of general availability, in a safe, controlled manner.
