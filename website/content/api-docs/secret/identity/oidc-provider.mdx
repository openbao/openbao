...
- `entity_ids` `([]string: <optional>)` - A list of OpenBao [entity](/docs/concepts/identity#entities-and-aliases) IDs.

- `group_ids` `([]string: <optional>)` – A list of OpenBao [group](/docs/concepts/identity#identity-groups) IDs.
