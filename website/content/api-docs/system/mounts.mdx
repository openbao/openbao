...
- `max_lease_ttl` `(int: 0)` <a name="max_lease_ttl-1"></a> – Specifies the maximum time-to-live. This
...
- `expose_public_paths` `(bool: false)` - Specifies whether requests from a public listener should be
  accepted for this mount's dedicated public paths.
