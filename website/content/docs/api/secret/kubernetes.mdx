...
[Kubernetes secrets engine documentation](../../secrets/kubernetes.mdx).
...
- `token_max_ttl` `(string: "")` - The maximum TTL for generated Kubernetes
  ...
  If not set or set to 0, the [system default](../../configuration/index.mdx#max_lease_ttl) will be used.
- `token_default_ttl` `(string: "")` - The default TTL for generated Kubernetes
  tokens, specified in seconds or as a Go duration format string, e.g. `"1h"`.
  If not set or set to 0, the [system default](../../configuration/index.mdx#default_lease_ttl) will be used.
- `token_default_audiences` `(string: "")` <a name="token_default_audiences"></a> - The default intended audiences for generated Kubernetes
...
- `name_template` `(string: "")` - The name template to use when generating
  ...
  used. See [username templating](../../concepts/username-templating.mdx)
