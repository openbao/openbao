...
3.  Configure a role that maps a name in OpenBao to an account in Active Directory.
    ...
    ```text
    $ bao write ad/roles/my-application \
...
```shell-session
$ bao write ad/library/accounting-team \
...
```shell-session
$ bao read ad/library/accounting-team/status
Key                 Value
---                 -----
...
```shell-session
$ bao write -f ad/library/accounting-team/check-out
Key                     Value
---                     -----
...
```shell-session
$ bao write ad/library/accounting-team/check-out ttl=30m
Key                     Value
---                     -----
...
```shell-session
$ bao lease renew ad/library/accounting-team/check-out/0C2wmeaDmsToVFc0zDiX9cMq
Key                Value
---                -----
...
```shell-session
$ bao write -f ad/library/accounting-team/check-in
Key          Value
---          -----
...
```shell-session
$ bao write ad/library/accounting-team/check-in service_account_names=fizz@example.com
Key          Value
---          -----
check_ins    [fizz@example.com]
```
...
```shell-session
$ bao write -f ad/library/manage/accounting-team/check-in
Key          Value
---          -----
check_ins    [fizz@example.com]
```
...
```shell-session
$ bao lease revoke ad/library/accounting-team/check-out/PvBVG0m7pEg2940Cb3Jw3KpJ
