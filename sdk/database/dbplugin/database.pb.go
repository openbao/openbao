...
const file_sdk_database_dbplugin_database_proto_rawDesc = "" +
	"\n" +
	"$sdk/database/dbplugin/database.proto\x12\bdbplugin\x1a\x1fgoogle/protobuf/timestamp.proto\"\\\n" +
	"\x11InitializeRequest\x12\x16\n" +
	"\x06config\x18\x01 \x01(\fR\x06config\x12+\n" +
	"\x11verify_connection\x18\x02 \x01(\bR\x10verifyConnection:\x02\x18\x01\"R\n" +
	"\vInitRequest\x12\x16\n" +
	"\x06config\x18\x01 \x01(\fR\x06config\x12+\n" +
	"\x11verify_connection\x18\x02 \x01(\bR\x10verifyConnection\"\xc8\x01\n" +
	"\x11CreateUserRequest\x124\n" +
	"\n" +
	"statements\x18\x01 \x01(\v2\x14.dbplugin.StatementsR\n" +
	"statements\x12A\n" +
	"\x0fusername_config\x18\x02 \x01(\v2\x18.dbplugin.UsernameConfigR\x0eusernameConfig\x12:\n" +
	"\n" +
	"expiration\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"expiration\"\xa0\x01\n" +
	"\x10RenewUserRequest\x124\n" +
	"\n" +
	"statements\x18\x01 \x01(\v2\x14.dbplugin.StatementsR\n" +
	"statements\x12\x1a\n" +
	...
	"expiration\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"expiration\"e\n" +
	"\x11RevokeUserRequest\x124\n" +
	"\n" +
	"statements\x18\x01 \x01(\v2\x14.dbplugin.StatementsR\n" +
	"statements\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\">\n" +
	"\x1cRotateRootCredentialsRequest\x12\x1e\n" +
	"\n" +
	"statements\x18\x01 \x03(\tR\n" +
	"statements\"\xec\x02\n" +
	"\n" +
	"Statements\x123\n" +
	"\x13creation_statements\x18\x01 \x01(\tB\x02\x18\x01R\x12creationStatements\x127\n" +
	"\x15revocation_statements\x18\x02 \x01(\tB\x02\x18\x01R\x14revocationStatements\x123\n" +
	"\x13rollback_statements\x18\x03 \x01(\tB\x02\x18\x01R\x12rollbackStatements\x12-\n" +
	"\x10renew_statements\x18\x04 \x01(\tB\x02\x18\x01R\x0frenewStatements\x12\x1a\n" +
	"\bcreation\x18\x05 \x03(\tR\bcreation\x12\x1e\n" +
	"\n" +
	"revocation\x18\x06 \x03(\tR\n" +
	"revocation\x12\x1a\n" +
	"\brollback\x18\a \x03(\tR\brollback\x12\x18\n" +
	"\arenewal\x18\b \x03(\tR\arenewal\x12\x1a\n" +
	"\brotation\x18\t \x03(\tR\brotation\"N\n" +
	"\x0eUsernameConfig\x12 \n" +
	"\vDisplayName\x18\x01 \x01(\tR\vDisplayName\x12\x1a\n" +
	...
	"\x1dRotateRootCredentialsResponse\x12\x16\n" +
	"\x06config\x18\x01 \x01(\fR\x06config\"\a\n" +
	"\x05Empty\"9\n" +
	"\x1bGenerateCredentialsResponse\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\tR\bpassword\"b\n" +
	"\x10StaticUserConfig\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x16\n" +
	"\x06create\x18\x03 \x01(\bR\x06create\"\x97\x01\n" +
	"\x15SetCredentialsRequest\x124\n" +
	"\n" +
	"statements\x18\x01 \x01(\v2\x14.dbplugin.StatementsR\n" +
	"statements\x12H\n" +
	"\x12static_user_config\x18\x02 \x01(\v2\x1a.dbplugin.StaticUserConfigR\x10staticUserConfig\"P\n" +
	"\x16SetCredentialsResponse\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword2\xab\x05\n" +
	"\bDatabase\x12/\n" +
	"\x04Type\x12\x0f.dbplugin.Empty\x1a\x16.dbplugin.TypeResponse\x12G\n" +
	"\n" +
	"CreateUser\x12\x1b.dbplugin.CreateUserRequest\x1a\x1c.dbplugin.CreateUserResponse\x128\n" +
	"\tRenewUser\x12\x1a.dbplugin.RenewUserRequest\x1a\x0f.dbplugin.Empty\x12:\n" +
	"\n" +
	"RevokeUser\x12\x1b.dbplugin.RevokeUserRequest\x1a\x0f.dbplugin.Empty\x12h\n" +
	"\x15RotateRootCredentials\x12&.dbplugin.RotateRootCredentialsRequest\x1a'.dbplugin.RotateRootCredentialsResponse\x125\n" +
	"\x04Init\x12\x15.dbplugin.InitRequest\x1a\x16.dbplugin.InitResponse\x12)\n" +
	"\x05Close\x12\x0f.dbplugin.Empty\x1a\x0f.dbplugin.Empty\x12S\n" +
	"\x0eSetCredentials\x12\x1f.dbplugin.SetCredentialsRequest\x1a .dbplugin.SetCredentialsResponse\x12M\n" +
	"\x13GenerateCredentials\x12\x0f.dbplugin.Empty\x1a%.dbplugin.GenerateCredentialsResponse\x12?\n" +
	"\n" +
	"Initialize\x12\x1b.dbplugin.InitializeRequest\x1a\x0f.dbplugin.Empty\"\x03\x88\x02\x01B5Z3github.com/openbao/openbao/sdk/v2/database/dbpluginb\x06proto3"
