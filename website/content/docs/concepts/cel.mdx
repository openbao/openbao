---
sidebar_label: Common Expression Language
...
and policies:
- [CEL for JWT Auth](/community/rfcs/cel-jwt)
- [CEL in PKI](/community/rfcs/cel-pki)
...
operator to craft CEL programs which adequately perform validation for the
context.
...
## Table of contents
 ...
 - [Variables in a CEL Program](#variables-in-a-cel-program)
