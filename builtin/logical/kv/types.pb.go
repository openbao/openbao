...
const file_builtin_logical_kv_types_proto_rawDesc = "" +
	"\n" +
	"\x1ebuiltin/logical/kv/types.proto\x12\x02kv\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"\xa2\x01\n" +
	"\rConfiguration\x12!\n" +
	"\fmax_versions\x18\x01 \x01(\rR\vmaxVersions\x12!\n" +
	"\fcas_required\x18\x02 \x01(\bR\vcasRequired\x12K\n" +
	"\x14delete_version_after\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x12deleteVersionAfter\"\xaf\x01\n" +
	...
	"\tdestroyed\x18\x03 \x01(\bR\tdestroyed\"\x9e\x05\n" +
	...
	" \x03(\v2#.kv.KeyMetadata.CustomMetadataEntryR\x0ecustomMetadata\x1aP\n" +
