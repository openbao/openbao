...
func (ns *NamespaceStore) ListNamespaces(ctx context.Context, parent *namespace.Namespace, includeParent bool, recursive bool) ([]*namespace.Namespace, error) {
	...
	for _, item := range ns.namespaces {
		...
		if !recursive && !item.Namespace.HasParent(parent) {
			continue
		}
...
func (ns *NamespaceStore) ListAllNamespaceUUIDs(ctx context.Context, includeRoot bool) ([]string, error) {
	return ns.ListNamespaceUUIDs(ctx, namespace.RootNamespace, includeRoot, true)
}

// ListNamespaceUUIDs is used to list namespace uuids below a parent namespace.
// Optionally it can include the parent namespace itself and/or include all
// decendents of the child namespaces.
func (ns *NamespaceStore) ListNamespaceUUIDs(ctx context.Context, parent *namespace.Namespace, includeParent bool, recursive bool) ([]string, error) {
...
func (ns *NamespaceStore) ListAllNamespaceAccessors(ctx context.Context, includeRoot bool) ([]string, error) {
	return ns.ListNamespaceAccessors(ctx, namespace.RootNamespace, includeRoot, true)
}

// ListNamespaceAccessors is used to list namespace accessor ids below a parent namespace.
// Optionally it can include the parent namespace itself and/or include all
// decendents of the child namespaces.
func (ns *NamespaceStore) ListNamespaceAccessors(ctx context.Context, parent *namespace.Namespace, includeParent bool, recursive bool) ([]string, error) {
...
func (ns *NamespaceStore) ListAllNamespacePaths(ctx context.Context, includeRoot bool) ([]string, error) {
	return ns.ListNamespacePaths(ctx, namespace.RootNamespace, includeRoot, true)
}
...
func (ns *NamespaceStore) ListNamespacePaths(ctx context.Context, parent *namespace.Namespace, includeParent bool, recursive bool) ([]string, error) {
