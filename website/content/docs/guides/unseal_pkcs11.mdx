---
sidebar_label: Auto-Unsealing with PKCS#11
---
...
This guide shows the easiest way to install the PKCS#11 plugin.
...
[new `kms` plugin type.](https://openbao.org/community/release-notes/2-6-0/#v260)
...
| Vendor | Models | Guides |
| --- | --- | --- |
| [DuoKey](https://duokey.com/) | DuoKey SD-HSM | [Product page](https://duokey.com/en/products/vault)    |
| [Nitrokey](https://www.nitrokey.com/) | NetHSM | [PKCS#11 installation guide](https://docs.nitrokey.com/en/nethsm/pkcs11-setup)  |
| [Securosys](https://www.securosys.com/) | Primus HSM, CloudHSM | [PKCS#11 installation guide](https://docs.securosys.com/pkcs/quickstart) |
| [Utimaco](https://utimaco.com/) | CryptoServer CP5, u.trust GP HSM |  |

## Running in containers

Most PKCS#11 libraries require glibc and do not work on systems based on musl libc, such as Alpine Linux.
For container users, this means you must use the `openbao-ubi` instead of the Alpine-based `openbao` image.

Historically, OpenBao has provided `openbao-hsm-ubi` and `openbao-ubi` images.
...
For your convenience, links for various vendors are provided above.
...
See the [containers guide](../../containers.mdx) for advice.
...
See the [OpenBao plugin system](https://openbao.org/docs/next/plugins/)
and the [`plugin` stanza](https://openbao.org/docs/next/configuration/plugins/)
documentation for more information about plugin installation.

## Step 3: Configure the `pkcs11` seal

Define the [PKCS#11 seal](https://openbao.org/docs/configuration/seal/pkcs11/) in the OpenBao configuration:
