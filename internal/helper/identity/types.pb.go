...
import (
	mfa "github.com/openbao/openbao/v2/internal/helper/identity/mfa"
...
const file_helper_identity_types_proto_rawDesc = "" +
	...
	"\bpolicies\x18\x03 \x03(\tR\bpolicies\x12(\n" +
	"\x10parent_group_ids\x18\x04 \x03(\tR\x0eparentGroupIDs\x12*\n" +
	"\x11member_entity_ids\x18\x05 \x03(\tR\x0fmemberEntityIDs\x129\n" +
	"\bmetadata\x18\x06 \x03(\v2\x1d.identity.Group.MetadataEntryR\bmetadata\x12?\n" +
	"\rcreation_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\x12D\n" +
	"\x10last_update_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x0elastUpdateTime\x12!\n" +
	"\fmodify_index\x18\t \x01(\x04R\vmodifyIndex\x12\x1d\n" +
	"\n" +
	"bucket_key\x18\n" +
	" \x01(\tR\tbucketKey\x12%\n" +
	"\x05alias\x18\v \x01(\v2\x0f.identity.AliasR\x05alias\x12\x12\n" +
	"\x04type\x18\f \x01(\tR\x04type\x12!\n" +
	"\fnamespace_id\x18\r \x01(\tR\vnamespaceID\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"9\n" +
	"\fLocalAliases\x12)\n" +
	"\aaliases\x18\x01 \x03(\v2\x0f.identity.AliasR\aaliases\"\x8c\x05\n" +
	"\x06Entity\x12)\n" +
	"\aaliases\x18\x01 \x03(\v2\x0f.identity.AliasR\aaliases\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12:\n" +
	"\bmetadata\x18\x04 \x03(\v2\x1e.identity.Entity.MetadataEntryR\bmetadata\x12?\n" +
	"\rcreation_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\x12D\n" +
	"\x10last_update_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0elastUpdateTime\x12*\n" +
	"\x11merged_entity_ids\x18\a \x03(\tR\x0fmergedEntityIDs\x12\x1a\n" +
	"\bpolicies\x18\b \x03(\tR\bpolicies\x12\x1d\n" +
	"\n" +
	"bucket_key\x18\t \x01(\tR\tbucketKey\x12A\n" +
	"\vmfa_secrets\x18\n" +
	" \x03(\v2 .identity.Entity.MFASecretsEntryR\n" +
	"mfaSecrets\x12\x1a\n" +
	"\bdisabled\x18\v \x01(\bR\bdisabled\x12!\n" +
	"\fnamespace_id\x18\f \x01(\tR\vnamespaceID\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aJ\n" +
	"\x0fMFASecretsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12!\n" +
	"\x05value\x18\x02 \x01(\v2\v.mfa.SecretR\x05value:\x028\x01\"\xe1\x05\n" +
	"\x05Alias\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fcanonical_id\x18\x02 \x01(\tR\vcanonicalID\x12\x1d\n" +
	"\n" +
	"mount_type\x18\x03 \x01(\tR\tmountType\x12%\n" +
	"\x0emount_accessor\x18\x04 \x01(\tR\rmountAccessor\x12\x1d\n" +
	"\n" +
	"mount_path\x18\x05 \x01(\tR\tmountPath\x129\n" +
	"\bmetadata\x18\x06 \x03(\v2\x1d.identity.Alias.MetadataEntryR\bmetadata\x12\x12\n" +
	"\x04name\x18\a \x01(\tR\x04name\x12?\n" +
	"\rcreation_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\x12D\n" +
	"\x10last_update_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0elastUpdateTime\x129\n" +
	"\x19merged_from_canonical_ids\x18\n" +
	" \x03(\tR\x16mergedFromCanonicalIDs\x12!\n" +
	"\fnamespace_id\x18\v \x01(\tR\vnamespaceID\x12L\n" +
	"\x0fcustom_metadata\x18\f \x03(\v2#.identity.Alias.CustomMetadataEntryR\x0ecustomMetadata\x12\x14\n" +
	"\x05local\x18\r \x01(\bR\x05local\x12(\n" +
	"\x10local_bucket_key\x18\x0e \x01(\tR\x0elocalBucketKey\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x12EntityStorageEntry\x127\n" +
	"\bpersonas\x18\x01 \x03(\v2\x1b.identity.PersonaIndexEntryR\bpersonas\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12F\n" +
	"\bmetadata\x18\x04 \x03(\v2*.identity.EntityStorageEntry.MetadataEntryR\bmetadata\x12?\n" +
	"\rcreation_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\x12D\n" +
	"\x10last_update_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0elastUpdateTime\x12*\n" +
	"\x11merged_entity_ids\x18\a \x03(\tR\x0fmergedEntityIDs\x12\x1a\n" +
	"\bpolicies\x18\b \x03(\tR\bpolicies\x12&\n" +
	"\x0fbucket_key_hash\x18\t \x01(\tR\rbucketKeyHash\x12M\n" +
	"\vmfa_secrets\x18\n" +
	" \x03(\v2,.identity.EntityStorageEntry.MFASecretsEntryR\n" +
	"mfaSecrets\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aJ\n" +
	"\x0fMFASecretsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12!\n" +
	"\x05value\x18\x02 \x01(\v2\v.mfa.SecretR\x05value:\x028\x01\"\xf9\x03\n" +
	"\x11PersonaIndexEntry\x12\x0e\n" +
	...
	"\x0emount_accessor\x18\x04 \x01(\tR\rmountAccessor\x12\x1d\n" +
	"\n" +
	"mount_path\x18\x05 \x01(\tR\tmountPath\x12E\n" +
	"\bmetadata\x18\x06 \x03(\v2).identity.PersonaIndexEntry.MetadataEntryR\bmetadata\x12\x12\n" +
	"\x04name\x18\a \x01(\tR\x04name\x12?\n" +
	"\rcreation_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\x12D\n" +
	"\x10last_update_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0elastUpdateTime\x123\n" +
	"\x16merged_from_entity_ids\x18\n" +
