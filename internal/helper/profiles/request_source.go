...
func RequestSourceBuilder(engine *ProfileEngine, field map[string]any, this *IterContext) Source {
...
func (s *RequestSource) Validate() ([]string, []string, error) {
	...
	if present {
		...
		default:
			return nil, nil, fmt.Errorf("unknown type for request source field 'field_selector': %T; expected either string, []string, or []any", rawFieldSelector)
		}
	}
...
func (s *RequestSource) Evaluate(_ context.Context, eh *EvaluationHistory) (any, error) {
