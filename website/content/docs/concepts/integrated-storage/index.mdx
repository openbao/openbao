...
process](/tutorials/getting-started/getting-started-deploy#initializing-the-vault),
...
OpenBao exposes two TCP ports: [the API port](/docs/configuration#api_addr) and
...
in the [`retry_join`](/docs/configuration/storage/raft#retry_join-stanza)
...
path](/docs/configuration/storage/raft/#path) of each OpenBao server. Inside that
