---
layout: docs
page_title: OpenBao Policies
sidebar_title: OpenBao Policies
description: |-
...
## Community decisions
 ...
 - [Deprecation Policy](/vault/docs/policies/deprecation), for executing the
   deprecation and removal of a feature from the code base.
 - [Plugin Support Policy](/vault/docs/policies/plugins), for deciding which
