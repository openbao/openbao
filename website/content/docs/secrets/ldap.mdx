...
To do this, OpenBao looks for either the same [entity ID](/tutorials/auth-methods/identity)
...
Refer to the [LDAP Secrets Engine](/tutorials/secrets-management/openldap)
