...
- Review the [Monitor telemetry and audit device log data](/tutorials/monitoring/monitor-telemetry-audit-splunk)
...
- Review the
  [Monitor telemetry with Prometheus and Grafana](/tutorials/monitoring/monitor-telemetry-grafana-prometheus)
