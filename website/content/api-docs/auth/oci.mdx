...
description: This is the API documentation for the OpenBao OCI auth method plugin.
---

# OCI auth method (API)

This is the API documentation for the OpenBao OCI auth method plugin. To
learn more about the usage and operation, see the
[OpenBao OCI auth method](/vault/docs/auth/oci).

This documentation assumes the OCI method is mounted at the
`/auth/oci` path in OpenBao. Since it is possible to enable auth methods at
any location, please update your API calls accordingly.

## Configure home tenancy method

Configure your home tenancy in the OpenBao, so that only users or instances from your tenancy will be allowed to log into OpenBao, through the OCI Auth method.
...
Create a OpenBao administrator role in the OCI Auth method.
