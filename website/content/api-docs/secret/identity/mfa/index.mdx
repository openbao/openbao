...
While the above endpoints are available in all editions of OpenBao,
they are namespace aware. MFA methods and login enforcements created in one namespace are separate from other
namespaces. In the community version of OpenBao, everything operates in the root namespace.
