...
// on a plain HTTP listener. A request is permitted if the requested path
// is set as an `AllowedPublicPath` in the mount's backend and if the mount's
// `expose_public_paths` tune value is set to true
