...
see the [OpenBao KV documentation](/vault/docs/secrets/kv/kv-v1). For information
...
See the [OpenBao KV secrets engine documentation](/vault/docs/secrets/kv/kv-v1#ttls)
for more details.
