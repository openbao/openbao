...
See [Password Policies](../../concepts/password-policies.mdx) for details of how password policies work
...
- `policy` `(string: <required>)` - Specifies the password policy document. This can be
  base64-encoded to avoid string escaping. See [Password Policy Syntax](../../concepts/password-policies.mdx#password-policy-syntax)
