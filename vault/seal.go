...
type SealConfig struct {
	...
	Type string `json:"type" mapstructure:"type" hcl:"type,label"`

	// SecretShares is the number of shares the secret is split into. This is
	// the N value of Shamir.
	SecretShares int `json:"secret_shares" mapstructure:"secret_shares" hcl:"secret_shares"`

	// SecretThreshold is the number of parts required to open the vault. This
	// is the T value of Shamir.
	SecretThreshold int `json:"secret_threshold" mapstructure:"secret_threshold" hcl:"secret_threshold"`
	...
	PGPKeys []string `json:"pgp_keys" mapstructure:"pgp_keys" hcl:"pgp_keys"`
	...
	Nonce string `json:"nonce" mapstructure:"nonce" hcl:"-"`
	...
	Backup bool `json:"backup" mapstructure:"backup" hcl:"-"`

	// Stores the progress of the rotation (key shares).
	RotationProgress [][]byte `json:"-" hcl:"-"`
