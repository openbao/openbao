...
log APIs](/api-docs/system/internal-counters#activity-export).  Instead,
...
OpenBao supports [path-based ACL Policies](/tutorials/getting-started/getting-started-policies)
...
Refer to the [Build Your Own Certificate Authority (CA)](/tutorials/secrets-management/pki-engine)
