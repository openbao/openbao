...
~> Plugin multiplexing requires `github.com/lf-edge/openbao/sdk v0.4.0` or above.
...
```shell-session
$ openbao write sys/plugins/catalog/database/mydatabase-database-plugin \
    sha256="..." \
    command="mydatabase"
...
```shell-session
$ openbao write database/config/mydatabase \
...
implement the
[`PluginVersioner`](https://github.com/lf-edge/openbao/blob/sdk/v0.6.0/sdk/logical/logical.go#L150-L154)
interface:
