...
Sealing a namepsace pauses the server's operations aimed at that namespace until
...
Auto-Unsealing is considered an important feature, as it is convienient in case
...
requiring a tenant to manually enter unseal key shares, which is incompatibile
