...
Recovery key generation using auto-unseal can be delayed until after
initialization and thus requires a root or policy with `sudo` access. Just
don't forget to generate them well before you need them!
