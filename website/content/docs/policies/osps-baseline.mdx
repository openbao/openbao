...
> **Requirement:** *When an attempt is made to delete the project's [primary branch](https://baseline.openssf.org/versions/2025-02-25#primary-branch), the [version control system](https://baseline.openssf.org/versions/2025-02-25#version-control-system) MUST treat this as a sensitive activity and require explicit confirmation of intent.*

The `main` branch is protected across all repositories to prevent unintended deletions. These [protection settings](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-protected-branches/about-protected-branches) include:
