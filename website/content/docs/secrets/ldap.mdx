...
The service account check-out functionality works with various [schemas](../api/secret/ldap.mdx#schema),
...
The LDAP secrets engine has a full HTTP API. Please see the [LDAP secrets engine API docs](../api/secret/ldap.mdx)
for more details.
