---
layout: docs
page_title: OpenBao Transit - Seals - Configuration
description: |-
...
Refer to the [Auto-unseal using Transit Secrets Engine](/tutorials/auto-unseal/autounseal-transit)
tutorial to learn how use the transit secrets engine to automatically unseal OpenBao.
