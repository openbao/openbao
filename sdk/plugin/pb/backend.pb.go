...
const file_sdk_plugin_pb_backend_proto_rawDesc = "" +
	"\n" +
	"\x1bsdk/plugin/pb/backend.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1asdk/logical/identity.proto\x1a\x18sdk/logical/plugin.proto\"\a\n" +
	"\x05Empty\" \n" +
	"\x06Header\x12\x16\n" +
	...
	"\x17write_forwarded_storage\x18\x05 \x03(\tR\x15writeForwardedStorage\"\xbf\x06\n" +
	"\aRequest\x12\x0e\n" +
	...
	"\blease_id\x18\x03 \x01(\tR\aleaseID\"\xc8\x02\n" +
	"\bResponse\x12\"\n" +
	...
	"\aheaders\x18\a \x03(\v2\x19.pb.Response.HeadersEntryR\aheaders\x1aF\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12 \n" +
	"\x05value\x18\x02 \x01(\v2\n" +
	...
	"\x03txn\x18\x02 \x01(\tR\x03txn\"k\n" +
	"\x13StorageListPageArgs\x12\x16\n" +
	...
	"\x03err\x18\x02 \x01(\tR\x03err\"J\n" +
	"\x0eStoragePutArgs\x12&\n" +
	"\x05entry\x18\x01 \x01(\v2\x10.pb.StorageEntryR\x05entry\x12\x10\n" +
	"\x03txn\x18\x02 \x01(\tR\x03txn\"#\n" +
	"\x0fStoragePutReply\x12\x10\n" +
	"\x03err\x18\x01 \x01(\tR\x03err\"7\n" +
	"\x11StorageDeleteArgs\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x10\n" +
	"\x03txn\x18\x02 \x01(\tR\x03txn\"&\n" +
	"\x12StorageDeleteReply\x12\x10\n" +
	"\x03err\x18\x01 \x01(\tR\x03err\"C\n" +
	"\x1bStorageIsTransactionalReply\x12$\n" +
	"\rtransactional\x18\x01 \x01(\bR\rtransactional\"9\n" +
	"\x13StorageBeginTxReply\x12\x10\n" +
	"\x03txn\x18\x01 \x01(\tR\x03txn\x12\x10\n" +
	"\x03err\x18\x02 \x01(\tR\x03err\"'\n" +
	"\x13StorageCommitTxArgs\x12\x10\n" +
	"\x03txn\x18\x01 \x01(\tR\x03txn\"(\n" +
	"\x14StorageCommitTxReply\x12\x10\n" +
	"\x03err\x18\x01 \x01(\tR\x03err\")\n" +
	"\x15StorageRollbackTxArgs\x12\x10\n" +
	"\x03txn\x18\x01 \x01(\tR\x03txn\"*\n" +
	"\x16StorageRollbackTxReply\x12\x10\n" +
	...
	"\fcertificates\x18\x01 \x03(\v2\x0f.pb.CertificateR\fcertificates2\xa5\x03\n" +
	"\aBackend\x12>\n" +
	...
	"\x04Type\x12\t.pb.Empty\x1a\r.pb.TypeReply2\xb5\x04\n" +
	"\aStorage\x121\n" +
	"\x04List\x12\x13.pb.StorageListArgs\x1a\x14.pb.StorageListReply\x129\n" +
	"\bListPage\x12\x17.pb.StorageListPageArgs\x1a\x14.pb.StorageListReply\x12.\n" +
	...
	"\x06Delete\x12\x15.pb.StorageDeleteArgs\x1a\x16.pb.StorageDeleteReply\x12=\n" +
	"\x0fIsTransactional\x12\t.pb.Empty\x1a\x1f.pb.StorageIsTransactionalReply\x125\n" +
	"\x0fBeginReadOnlyTx\x12\t.pb.Empty\x1a\x17.pb.StorageBeginTxReply\x12-\n" +
	"\aBeginTx\x12\t.pb.Empty\x1a\x17.pb.StorageBeginTxReply\x12;\n" +
	"\x06Commit\x12\x17.pb.StorageCommitTxArgs\x1a\x18.pb.StorageCommitTxReply\x12A\n" +
	"\bRollback\x12\x19.pb.StorageRollbackTxArgs\x1a\x1a.pb.StorageRollbackTxReply2\xe1\x05\n" +
	"\n" +
	"SystemView\x12*\n" +
	...
	"\vClusterInfo\x12\t.pb.Empty\x1a\x14.pb.ClusterInfoReplyB-Z+github.com/openbao/openbao/sdk/v2/plugin/pbb\x06proto3"
