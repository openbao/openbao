...
Cappos proposed a model for Shamir's that worked by "encrypting" (to use the
term loosely) the Shamir shares using a password scheme. Supposing such a
scheme could exist, we'd care about the following properties:
