...
Note: As of v2.5.3 usage of these endpoints is [deprecated](/docs/deprecation/unauthed-generate-root)
and will be disabled by default. Considering using [`auth/token/create`](../../auth/token.mdx)
...
[listener parameter](/docs/configuration/listener/unix/).
