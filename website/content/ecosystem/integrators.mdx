...
<Randomize>
  ...
  <Member title="GatePlane" logoName="gateplane">
      [GatePlane](https://gateplane.io/) provides full IAM integration for OpenBao, turning it to a Privileged Access Management (PAM) solution, supporting approval-based conditional access (under their always-free Community License) through their [OpenBao plugins](https://github.com/gateplane-io/vault-plugins).
  </Member>
