...
* database: all database plugins now ignore "not found" errors on revoke by default. See [Plugin Author Guide](/docs/plugins/plugin-authors-guide#revoke-operations-should-ignore-not-found-errors) for rationale. [[GH-2101](https://github.com/openbao/openbao/pull/2101)]
...
* core/seal: Remove the undocumented "aead" seal mechanism. Consider switching to the [static seal](/docs/configuration/seal/static) instead as a replacement. [[GH-1910](https://github.com/openbao/openbao/pull/1910)]
