...
| ----------------------- |
| [How has client count changed across different OpenBao versions?](#logic-improvements) |
| [How has the usage metric UI changed across different OpenBao versions?](#ui-improvements) |
...
| OpenBao auditor tool      |
| ----------------------- |
| [What is the OpenBao auditor?](##openbao-auditor) |
