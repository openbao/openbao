...
description: |-
  The MongoDB Atlas plugin for OpenBao's Database Secrets Engine generates MongoDB Database User credentials for MongoDB Atlas.
---
...
Statements are configured during OpenBao role creation and are used by the plugin to
