...
1. **Manual management** - Manual download of plugin binaries and registration via CLI/API
2. **OCI-based distribution** - Automatic download from container registries with declarative configuration and registration via CLI/API

See the [OCI Plugin](/docs/configuration/oci-plugins) configuration reference
