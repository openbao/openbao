...
module('Integration | Component | form field', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.strictEqual(component.fields[0].labelText, 'Foo', 'renders a label');
  ...
  test('it uses a passed label', async function (assert) {
    ...
    assert.strictEqual(component.fields[0].labelText, 'Not Foo', 'renders the label from options');
  });
