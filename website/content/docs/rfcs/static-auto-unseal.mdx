...
on SIGHUP currenlty. When [Parallel Unseal](https://github.com/openbao/openbao/issues/1021)
...
https://github.com/openbao/go-kms-wrapping/compare/main...cipherboy:go-kms-wrapping:static-unseal-method?expand=1
