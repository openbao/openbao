...
3. Authorization storage
   1. Request, authorization details, and response will be stored in `cubbyhole`.
...
A workflow for requesting/granting in the UI could make admistra2tion easier. 
...
Reusing the response wrapping framework should be familiar, but the developer will need
