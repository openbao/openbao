...
description: |-
  Manage credentials for IBM Db2 using OpenBao's LDAP secrets engine.
---
...
identities in Db2 aren't capable of being managed using SQL statements and OpenBao's
...
OpenBao's [LDAP secrets engine](/vault/docs/secrets/ldap) can be used to manage the lifecycle
...
tutorial to learn how to use OpenBao to manage both static and dynamic credentials for access to Db2.
