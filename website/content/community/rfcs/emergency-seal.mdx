...
foundation that will seamlessly integrate with the full Parallel Unseal
...
The emergency seal is stored in storage as a fully-formed, independent seal
...
To ensure forward compatibility and reduce future work, the API and CLI changes
