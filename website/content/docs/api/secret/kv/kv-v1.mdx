...
see the [OpenBao KV documentation](../../../secrets/kv/kv-v1.mdx). For information
about the differences between KV version 1 and version 2, please [see the KV overview
documentation](../../../secrets/kv/index.mdx).
...
See the [OpenBao KV secrets engine documentation](../../../secrets/kv/kv-v1.mdx#ttls)
for more details.
...
- `:key` `(string: "")` – Specifies a key in the payload, paired with an associated value, to
  ...
  documentation](../../../secrets/kv/kv-v1.mdx#ttls) for details.
