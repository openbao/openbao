...
1. [Download](/vault/downloads) the OpenBao binary where the client application runs
(virtual machine, Kubernetes pod, etc.)

1. Create a OpenBao Proxy configuration file. (See the [Example
Configuration](#example-configuration) section for an example configuration.)

1. Start a OpenBao Proxy with the configuration file.
