...
:::tip[Start with key health metrics]

  The [Well-Architected Framework](/well-architected-framework) documentation
  includes a best practices guide on
  [key OpenBao metrics for common health checks](/well-architected-framework/reliability/reliability-vault-monitoring-key-metrics).
