...
:::warning[Do not use static roles for root database credentials]
   ...
   [Rotate root credentials](../../api/secret/databases/index.mdx#rotate-root-credentials)
   API endpoint.
...
and passwords. The [credential_type](../../api/secret/databases/index.mdx)
and [credential_config](../../api/secret/databases/index.mdx) parameters
...
docs](../../api/secret/databases/index.mdx#common-fields) and reference individual
...
secrets engine API](../../api/secret/databases/index.mdx) for more details.
