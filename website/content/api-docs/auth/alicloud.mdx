...
description: This is the API documentation for the OpenBao AliCloud auth method.
---

# AliCloud auth method (API)

This is the API documentation for the OpenBao AliCloud auth method. For
general information about the usage and operation of the AliCloud method, please
see the [OpenBao AliCloud auth method documentation](/vault/docs/auth/alicloud).
