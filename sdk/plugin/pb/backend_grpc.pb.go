...
func (UnimplementedBackendServer) SpecialPaths(context.Context, *Empty) (*SpecialPathsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method SpecialPaths not implemented")
}
func (UnimplementedBackendServer) HandleExistenceCheck(context.Context, *HandleExistenceCheckArgs) (*HandleExistenceCheckReply, error) {
	return nil, status.Error(codes.Unimplemented, "method HandleExistenceCheck not implemented")
}
...
const (
	...
	Storage_ListPage_FullMethodName        = "/pb.Storage/ListPage"
	...
	Storage_IsTransactional_FullMethodName = "/pb.Storage/IsTransactional"
	Storage_BeginReadOnlyTx_FullMethodName = "/pb.Storage/BeginReadOnlyTx"
	Storage_BeginTx_FullMethodName         = "/pb.Storage/BeginTx"
	Storage_Commit_FullMethodName          = "/pb.Storage/Commit"
	Storage_Rollback_FullMethodName        = "/pb.Storage/Rollback"
)
...
// implement the client for this service. If we have a transactional aware
// client and server, the client can detect this by calling IsTransactional()
// which returns a single boolean if the underlying storage is transactional.
// If it is, the logical.Transaction+logical.Transactional calls will be
// supported and logical.Storage calls can take an optional txn identifier,
// if the call is to be made in a transaction. Transaction identifiers will
// be UUIDs to prevent accidental confusion.
...
func (c *storageClient) ListPage(ctx context.Context, in *StorageListPageArgs, opts ...grpc.CallOption) (*StorageListReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StorageListReply)
	err := c.cc.Invoke(ctx, Storage_ListPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) IsTransactional(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StorageIsTransactionalReply, error) {
	...
	err := c.cc.Invoke(ctx, Storage_IsTransactional_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) BeginReadOnlyTx(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StorageBeginTxReply, error) {
	...
	err := c.cc.Invoke(ctx, Storage_BeginReadOnlyTx_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) BeginTx(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StorageBeginTxReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StorageBeginTxReply)
	err := c.cc.Invoke(ctx, Storage_BeginTx_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) Commit(ctx context.Context, in *StorageCommitTxArgs, opts ...grpc.CallOption) (*StorageCommitTxReply, error) {
	...
	err := c.cc.Invoke(ctx, Storage_Commit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) Rollback(ctx context.Context, in *StorageRollbackTxArgs, opts ...grpc.CallOption) (*StorageRollbackTxReply, error) {
	...
	err := c.cc.Invoke(ctx, Storage_Rollback_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStorageServer) IsTransactional(context.Context, *Empty) (*StorageIsTransactionalReply, error) {
	return nil, status.Error(codes.Unimplemented, "method IsTransactional not implemented")
}
func (UnimplementedStorageServer) BeginReadOnlyTx(context.Context, *Empty) (*StorageBeginTxReply, error) {
	return nil, status.Error(codes.Unimplemented, "method BeginReadOnlyTx not implemented")
}
...
func _Storage_ListPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_ListPage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Storage_IsTransactional_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_IsTransactional_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Storage_BeginReadOnlyTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_BeginReadOnlyTx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Storage_BeginTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_BeginTx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Storage_Commit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_Commit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Storage_Rollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_Rollback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (UnimplementedSystemViewServer) GeneratePasswordFromPolicy(context.Context, *GeneratePasswordFromPolicyRequest) (*GeneratePasswordFromPolicyReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GeneratePasswordFromPolicy not implemented")
}
...
func RegisterSystemViewServer(s grpc.ServiceRegistrar, srv SystemViewServer) {
	// If the following call panics, it indicates UnimplementedSystemViewServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
