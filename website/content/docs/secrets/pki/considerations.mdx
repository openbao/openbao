...
As such, we strongly recommend publicly facing OpenBao instances (such as HCP
...
System administrators of OpenBao instances can enforce this by [setting the
...
In this case, the CSR will need to be generated outside of OpenBao and the
