...
Each OpenBao namespace has a default OIDC [provider](../../concepts/oidc-provider.mdx#oidc-providers)
and [key](../../concepts/oidc-provider.mdx#keys). This built-in configuration enables client
...
[OIDC identity provider API](../../api/secret/identity/oidc-provider.mdx) for more
details.
