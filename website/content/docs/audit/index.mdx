...
audit log. Starting with OpenBao v2.3.2, this option is only supported if
`allow_audit_log_prefixing = true` is set in the [server configuration](/docs/configuration).
