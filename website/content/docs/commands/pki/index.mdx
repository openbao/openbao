...
To [verify](/docs/commands/pki/verify-sign) the signature between two
...
To [list intermediate](/docs/commands/pki/list-intermediates) certificates
...
To [issue](/docs/commands/pki/issue) a new issuer certificate, use the
...
To [reissue](/docs/commands/pki/reissue) an issuer certificate, using the
