...
You can also use [OpenBao's password policy](/docs/concepts/password-policies) feature to generate arbitrary values.
...
Engine](/tutorials/secrets-management/static-secrets)
