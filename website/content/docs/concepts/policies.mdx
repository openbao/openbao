...
[![OpenBao Auth Workflow](/img/vault-policy-workflow.svg)](/img/vault-policy-workflow.svg)
...
[![OpenBao Auth Workflow](/img/vault-auth-workflow.svg)](/img/vault-auth-workflow.svg)
...
**Usage example:** The [ACL Policy Path
     Templating](/tutorials/policies/policy-templating)
     ...
     method](/docs/auth/userpass) to log in with OpenBao.
...
- [Production Hardening](/tutorials/operations/production-hardening)
- [Generating a Root Token](/tutorials/operations/generate-root)
...
- [OpenBao Policies](/tutorials/policies/policies)
- [ACL Policy Path Templating](/tutorials/policies/policy-templating)
