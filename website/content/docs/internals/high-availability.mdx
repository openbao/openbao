...
- [OpenBao with Integrated Storage Reference Architecture](/tutorials/day-one-raft/raft-reference-architecture)
- [OpenBao HA Cluster with Integrated Storage](/tutorials/raft/raft-storage)
