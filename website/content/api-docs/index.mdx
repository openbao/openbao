...
the request is being sent to a OpenBao Agent or directly to a OpenBao Server. In
...
Additionally, with the [OpenAPI generation](/vault/api-docs/system/internal-specs-openapi) in OpenBao, you will get back a small
...
- `412` - Precondition failed.  Returned on Enterprise when a request can't be
  ...
  See [OpenBao Eventual Consistency](/vault/docs/enterprise/consistency).
