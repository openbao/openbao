...
The Password policies [API docs can be found here](/vault/api-docs/system/policies-password).
...
[![OpenBao Password Policy Flow](/img/vault-password-policy-flow.svg)](/img/vault-password-policy-flow.svg)
