...
import (
	...
	"github.com/openbao/openbao/command/template/watch"
...
func (r *Runner) Start() {
	...
	OUTER:
		...
		case view := <-r.watcher.DataCh():
			...
			//
			// Please see https://github.com/openbao/openbao/command/template/issues/168 for
...
func (r *Runner) Receive(d dep.Dependency, data interface{}) {
	...
	//
	//     https://github.com/openbao/openbao/command/template/issues/198
	//
