...
This secrets engine is available as an external secret plugin in the
[openbao-plugins](https://github.com/openbao/openbao-plugins) plugin
collection. For more information on plugins, see the [overview
section](../plugins/index.mdx).
