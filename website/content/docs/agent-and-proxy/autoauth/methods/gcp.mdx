---
layout: docs
page_title: OpenBao Auto-Auth GCP Method
description: GCP Method for OpenBao Auto-Auth
---

# OpenBao Auto-Auth GCP method
...
OpenBao will use the GCP SDK's normal credential chain behavior. You can set a
