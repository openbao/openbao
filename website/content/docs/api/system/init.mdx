...
initialized. The recovery options are only available when using [Auto Unseal](../../concepts/seal.mdx#auto-unseal).
...
the full warning in the documentation for [Auto Unseal](../../concepts/seal.mdx#auto-unseal).
