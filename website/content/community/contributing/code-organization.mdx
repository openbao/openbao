...
breaking to consumers of the library. Some key files are:
 ...
 - [`api/sys_*.go`](https://github.com/search?q=repo%3Aopenbao%2Fopenbao%20api%2Fsys&type=code),
   ...
   [`sys/`](/docs/api/system), authenticating to OpenBao, or the
...
two main sections:
 ...
 - [`api-docs`](/docs/api/) a hand-maintained API reference to all endpoints
   in OpenBao.
...
else if the page is under `community/`, then to
[`website/sidebarsCommunity.ts`](https://github.com/openbao/openbao/tree/main/website/sidebarsCommunity.ts)).
...
At a high level, these directories are:
 ...
 - [`internal/audit/`](https://github.com/openbao/openbao/tree/main/internal/audit/) contains
   interface definitions for auditing requests and responses.
 - [`internal/builtin/`](https://github.com/openbao/openbao/tree/main/internal/builtin/) contains
   the builtin plugins:
   - [`internal/builtin/audit/`](https://github.com/openbao/openbao/tree/main/internal/builtin/audit)
     contains the built-in audit backends such as [file](/docs/audit/file) or
     [syslog](/docs/audit/syslog).
   - [`internal/builtin/credential/`](https://github.com/openbao/openbao/tree/main/internal/builtin/credential)
     contains the built-in authentication plugins such as
     [AppRole](/docs/auth/approle) or [cert](/docs/auth/cert).
   - [`internal/builtin/logical/`](https://github.com/openbao/openbao/tree/main/internal/builtin/logical)
     contains the built-in secret engines such as
     [PKI](/docs/secrets/pki) or [kv](/docs/secrets/kv).
   - [`internal/builtin/plugin/`](https://github.com/openbao/openbao/tree/main/internal/builtin/plugin)
 ...
 - [`internal/command/`](https://github.com/openbao/openbao/tree/main/internal/command/) contains
   the CLI interface definitions: each command is in a separate file connected
   through [`internal/command/commands.go`](https://github.com/openbao/openbao/blob/main/internal/command/commands.go).
 ...
 - [`internal/helper/`](https://github.com/openbao/openbao/tree/main/internal/helper/) includes
   various internal libraries useful only in the context of OpenBao.
 - [`internal/http/`](https://github.com/openbao/openbao/tree/main/internal/http/) contains
 ...
 - [`internal/plugins/database/`](https://github.com/openbao/openbao/tree/main/internal/plugins/database/)
 ...
 - [`internal/serviceregistration/`](https://github.com/openbao/openbao/tree/main/internal/serviceregistration/)
   contains helpers for supporting service registration against various
   providers. This is only utilized by OpenBao Server.
 - [`internal/vault/`](https://github.com/openbao/openbao/tree/main/internal/vault/)
   contains the [Core](https://github.com/openbao/openbao/blob/main/internal/vault/core.go)
   of the server: this implements
   [barrier encryption](https://github.com/openbao/openbao/blob/main/internal/vault/barrier.go),
   [identity storage](https://github.com/openbao/openbao/blob/main/internal/vault/identity_store.go),
   [token storage](https://github.com/openbao/openbao/blob/main/internal/vault/token_store.go),
