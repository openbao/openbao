...
description: This is the API documentation for the OpenBao Cassandra secrets engine.
---
...
This is the API documentation for the OpenBao Cassandra secrets engine. For
general information about the usage and operation of the Cassandra backend,
please see the
[OpenBao Cassandra backend documentation](/vault/docs/secrets/databases/cassandra).
...
{
  "data": {
    "username": "openbao-root-1430158508-126",
