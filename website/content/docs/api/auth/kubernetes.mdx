...
If unset and disable_local_ca_jwt is false, OpenBao uses the local Kubernetes CA certificate. If unset and disable_local_ca_jwt is true, OpenBao uses the host system trust store.
