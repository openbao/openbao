...
information, see the [OpenBao JWT/OIDC method documentation](/vault/docs/auth/jwt).
...
and additions may be submitted via the [OpenBao Github repository](https://github.com/hashicorp/openbao).
