...
Caching](/docs/agent-and-proxy/agent/caching/persistent-caches) page for more information on
this functionality.
...
[described in the API Proxy documentation](/docs/agent-and-proxy/agent/apiproxy#configuration-api_proxy) only to
...
[agent-template]: /docs/agent-and-proxy/agent/template
[agent-listener]: /docs/agent-and-proxy/agent#listener-stanza
...
the [API Proxy](/docs/agent-and-proxy/agent/apiproxy) and enables the API proxy to use the cache, if configured.
...
Caching](/tutorials/vault-agent/agent-caching)
