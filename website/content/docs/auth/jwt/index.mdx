...
If you plan to support authentication via `bao login -method=oidc`, a localhost redirect URI
...
- [OIDC Auth Method](/tutorials/auth-methods/oidc-auth)
- [Azure Active Directory with OIDC Auth Method and External
  Groups](/tutorials/auth-methods/oidc-auth-azure)
- [OIDC Authentication with Okta](/tutorials/auth-methods/vault-oidc-okta)
- [OIDC Authentication with Google Workspace](/tutorials/auth-methods/google-workspace-oauth)
