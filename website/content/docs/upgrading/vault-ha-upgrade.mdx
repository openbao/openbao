...
default automated upgrade migrations feature of the Vault. Without disabling
this feature, you may run into Lost Quorum issue as described in the [Quorum
lost while upgrading the vault from 1.11.0 to later version of
