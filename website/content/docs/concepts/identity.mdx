...
~> OpenBao Entity is used to count the number of OpenBao clients. To learn more
...
Groups](/vault/tutorials/auth-methods/identity) tutorial to learn how OpenBao supports mutliple authentication methods and enables the same authentication method to be used with different mount paths.
