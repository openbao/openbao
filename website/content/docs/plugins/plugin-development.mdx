...
[Building Plugin Backends](/tutorials/app-integration/plugin-backends)
tutorial.
...
* [Custom Secrets Engines](/tutorials/custom-secrets-engine)

### Plugin development - resources - community

See the [OpenBao Integrations](/integrations) page to find Community
