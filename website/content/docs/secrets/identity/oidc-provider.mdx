...
OpenBao's source of [identity](/docs/concepts/identity) and wide range of [authentication methods](/docs/auth)
...
Each OpenBao namespace has a default OIDC [provider](/docs/concepts/oidc-provider#providers)
...
2. Create a client application:
   ...
   To allow all OpenBao entities to authenticate, the built-in [allow_all](/docs/concepts/oidc-provider#assignments)
...
Refer to the [OpenBao as an OIDC Identity Provider](/tutorials/auth-methods/oidc-identity-provider)
