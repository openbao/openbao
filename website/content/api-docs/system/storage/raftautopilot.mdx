...
with OpenBao's [Integrated Storage backend](/vault/docs/internals/integrated-storage).
...
- `disable_upgrade_migration` `(bool: false)` - Disables automatically upgrading OpenBao using
