...
- [AliCloud KMS](/docs/configuration/seal/alicloudkms)
- [AWS KMS](/docs/configuration/seal/awskms)
- [Azure Key Vault](/docs/configuration/seal/azurekeyvault)
- [GCP Cloud KMS](/docs/configuration/seal/gcpckms)
- [OCI KMS](/docs/configuration/seal/ocikms)
- [OpenBao Transit](/docs/configuration/seal/transit)

Additionally, generic vendor-free mechanisms include:

- [KMIP](/docs/configuration/seal/kmip)
- [PKCS#11](/docs/configuration/seal/pkcs11)
- [Static Key](/docs/configuration/seal/static)
...
2. An OpenBao instance usually uses only one seal mechanisms at a time (two during
   [Seal Migration](/docs/concepts/seal)). This number
