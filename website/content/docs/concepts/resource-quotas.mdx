...
through various [metrics](../internals/telemetry/metrics/core-system.mdx#quota-metrics) exposed
...
[Rate Limit Quotas API](../api/system/rate-limit-quotas.mdx) for more details.
