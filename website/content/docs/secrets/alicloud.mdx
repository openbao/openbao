...
1.  Configure a role describing how credentials will be granted.
    ...
    ```text
    $ bao write alicloud/role/policy-based \
    ...
    ```text
    $ bao write alibaba/role/role-based \
...
1.  Generate a new access key by reading from the `/creds` endpoint with the name
    ...
    ```text
    $ bao read alicloud/creds/policy-based
    Key                Value
    ---                -----
    ...
    ```text
    $ bao read alicloud/creds/role-based
    Key                Value
    ---                -----
