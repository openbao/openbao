...
OpenBao uses GitHub repository rulesets to protect all important project repositories. The rulesets in place do not allow force pushes to the default as well as `release/*` branches. In addition, the GitHub UI does not allow deleting the default branch.
...
Every [OpenBao release on GitHub](https://github.com/openbao/openbao/releases) contains a source code ZIP file archive. This archive contains a snapshot of the source code at release time and therefore the corresponding LICENSE file.
