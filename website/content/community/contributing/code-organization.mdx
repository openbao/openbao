...
At a high level, these directories are:
 ...
 - [`internal/command/`](https://github.com/openbao/openbao/tree/main/command/) contains
   the CLI interface definitions: each command is in a separate file connected
   through [`command/commands.go`](https://github.com/openbao/openbao/blob/main/internal/command/commands.go).
