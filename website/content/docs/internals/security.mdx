...
- **Protecting against flaws in external systems or services used by OpenBao.**
  ...
  For example, misconfiguration or compromise of third-party IdPs
  (including, but not limited to, the issuance of JWTs with malicious claims)
  is considered out of scope for the OpenBao threat model.
...
[unseal challenge](../concepts/integrated-storage/index.mdx#openbao-networking-recap).
