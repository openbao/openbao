...
The below configuration will migrate away from integrated storage to PostgreSQL
storage. For more configuration options see the [raft storage configuration
documentation](../../configuration/storage/raft.mdx) and
[PostgreSQL configuration documentation](../../configuration/storage/postgresql.mdx).
