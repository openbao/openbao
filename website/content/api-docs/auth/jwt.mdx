...
- `oidc_discovery_url` `(string: <optional>)` - The OIDC Discovery URL, any .well-known component will be trimmed by default. Cannot be used with "jwks_url" or "jwt_validation_pubkeys".
