...
This page lists known issues for [OpenBao releases](/community/release-notes) and any
...
use mlock. In 2.0.0 prior to GA, [mlock was removed](/community/rfcs/mlock-removal)
