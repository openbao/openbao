...
description: |-
  ...
  roles for the Valkey database, and also supports [Static Roles](/docs/secrets/databases#static-roles).
---
...
The full list of configurable options can be seen in the [Valkey Database Plugin API](/api-docs/secret/databases/valkey) page.
