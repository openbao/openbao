...
|------------------------------------------------------------|--------------------------|---------------|--------------|------------------------|------------------|
| [Cassandra](/vault/docs/secrets/databases/cassandra)       | Yes                      | Yes           | Yes          | Yes                    | password         |
| [InfluxDB](/vault/docs/secrets/databases/influxdb)         | Yes                      | Yes           | Yes          | Yes                    | password         |
| [MySQL/MariaDB](/vault/docs/secrets/databases/mysql-maria) | Yes                      | Yes           | Yes          | Yes                    | password         |
| [PostgreSQL](/vault/docs/secrets/databases/postgresql)     | Yes                      | Yes           | Yes          | Yes                    | password         |
