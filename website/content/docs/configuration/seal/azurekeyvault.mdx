...
[Production
Hardening](/tutorials/operations/production-hardening) tutorial
...
Refer to the [Auto-unseal using Azure Key Vault](/tutorials/auto-unseal/autounseal-azure-keyvault)
tutorial to learn how to use the Azure Key Vault to auto-unseal an OpenBao server.
