...
- The `distinct_entities` field name has been deprecated. Refer to
...
- The `non_entity_tokens` field name has been deprecated. Refer to
...
Note: the client count may be inaccurate in the moments following an OpenBao
