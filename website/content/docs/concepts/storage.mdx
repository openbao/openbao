...
and cronjobs while for [Kubernetes we provide a container image and 
CronJob resource](https://github.com/openbao/openbao-snapshot-agent/blob/main/docs/k8s-configuration.md).
The Kubernetes CronJob can also be configured and deployed via 
