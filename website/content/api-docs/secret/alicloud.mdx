...
description: This is the API documentation for the OpenBao AliCloud secrets engine.
---

# AliCloud secrets engine (API)

This is the API documentation for the OpenBao AliCloud secrets engine. For general
information about the usage and operation of the AliCloud secrets engine, please see
the [OpenBao AliCloud documentation](/vault/docs/secrets/alicloud).
...
Please see the [OpenBao AliCloud documentation](/vault/docs/secrets/alicloud) for
...
The `role` endpoint configures how OpenBao will generate credentials for users of each role.
...
- `role_arn` (string, optional) - The ARN of a role that will be assumed to obtain STS credentials. See [OpenBao AliCloud documentation](/vault/docs/secrets/alicloud) regarding trusted actors.
...
Performing a `LIST` on the `/alicloud/roles` endpoint will list the names of all the roles OpenBao contains.
