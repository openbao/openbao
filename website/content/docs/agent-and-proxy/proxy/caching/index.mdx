---
layout: docs
page_title: OpenBao Proxy Caching
description: |-
...
Caching](/docs/agent-and-proxy/proxy/caching/persistent-caches) page for more information on
this functionality.
...
[proxy-listener]: /docs/agent-and-proxy/proxy#listener-stanza
...
the [API Proxy](/docs/agent-and-proxy/proxy/apiproxy) and enables the API proxy to use the cache, if configured.
