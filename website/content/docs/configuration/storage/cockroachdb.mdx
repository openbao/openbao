...
description: >-
  The CockroachDB storage backend is used to persist OpenBao's data in a
...
- `table` `(string: "openbao_kv_store")` – Specifies the name of the table in
  which to write OpenBao data. If this table does not exist OpenBao will attempt to create it.
