...
func TestRaftStorageQuorum(t *testing.T) {
	...
	twoVoterCluster := RaftStorageQuorum(t.Context(), m)
	...
	threeVoterCluster := RaftStorageQuorum(t.Context(), m)
	...
	threeNodeTwoVoterCluster := RaftStorageQuorum(t.Context(), m)
	...
	errClusterInfo := RaftStorageQuorum(t.Context(), m)
