...
description: >-
  The MSSQL storage backend is used to persist OpenBao's data in a Microsoft SQL
  Server.
---

# MSSQL storage backend

The MSSQL storage backend is used to persist OpenBao's data in a Microsoft SQL Server.
...
- `appname` `(string: "OpenBao")` – the application name.
