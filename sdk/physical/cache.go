...
func (c *cache) cloneWithStorage(b Backend) *cache {
	...
	// fresh, localized cache. This is globally sub-optimal (as it purges
	// everything), but easiest to implement (as the transaction can modify
	// its cache as it pleases).
