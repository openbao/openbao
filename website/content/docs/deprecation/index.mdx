...
| Unauthenticated Rekey & Root Rotation Endpoints | [Link](unauthed-rekey.mdx) | v2.4.0 | n/a | Move to future authenticated variants or set `disable_unauthed_rekey_endpoints=false` in listeners explicitly. | [Listener Configuration](../configuration/listener/index.mdx) |
