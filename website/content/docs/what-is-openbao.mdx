...
![How OpenBao Works](/img/how-vault-works.png)
...
![OpenBao Workflow](/img/vault-workflow-diagram1.png)
...
-> **Tip**: Learn more about OpenBao [use cases](/vault/docs/use-cases).
...
* Read our [contributing guide](https://github.com/lf-edge/openbao/blob/main/CONTRIBUTING.md).
* [Submit an issue](https://github.com/lf-edge/openbao/issues/new/choose) for bugs and feature requests.
