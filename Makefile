...
.PHONY: dev-gorelease
dev-gorelease: export GORELEASER_PREVIOUS_TAG := $(shell git describe --tags $(shell git rev-list --tags --max-count=1))
dev-gorelease: export GORELEASER_CURRENT_TAG := v999.999.999
