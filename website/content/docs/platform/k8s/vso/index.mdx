...
- Prometheus specific instrumentation for [monitoring](/docs/platform/k8s/vso/telemetry) the Operator.
- Support for installing using: `Helm` or `Kustomize`<br />
*see the [installation](/docs/platform/k8s/vso/installation) docs for more details*

## Supported secret sources

The Vault Secrets Operator supports syncing from multiple secret sources.
Refer to the [secret sources overview](/docs/platform/k8s/vso/sources) for more details.
