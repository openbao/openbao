...
[`api_proxy` stanza](/docs/agent-and-proxy/proxy/apiproxy#configuration-api_proxy).
...
See the [caching](/docs/agent-and-proxy/proxy/caching#api) page for details on the cache API.
...
- `template` <code>([template][template]: \<optional>)</code> - Specifies options used for templating OpenBao secrets to files.
...
reporting system. See the [telemetry Stanza](/docs/agent-and-proxy/proxy#telemetry-stanza) section below
...
- `enable_quit` `(bool: false)` - If set to `true`, the Proxy will enable the [quit](/docs/agent-and-proxy/proxy#quit) API.
...
[vault]: /docs/agent-and-proxy/proxy#vault-stanza
[autoauth]: /docs/agent-and-proxy/autoauth
[caching]: /docs/agent-and-proxy/proxy/caching
[apiproxy]: /docs/agent-and-proxy/proxy/apiproxy
[persistent-cache]: /docs/agent-and-proxy/proxy/caching/persistent-caches
[template]: /docs/agent-and-proxy/proxy/template
[template-config]: /docs/agent-and-proxy/proxy/template#template-configurations
[proxy-api]: /docs/agent-and-proxy/proxy/#proxy_api-stanza
[listener]: /docs/agent-and-proxy/proxy#listener-stanza
