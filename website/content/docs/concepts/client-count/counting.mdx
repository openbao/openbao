...
unique entity assignments within a OpenBao cluster over a given billing period:
...
OpenBao does not aggregate or de-duplicate clients across clusters, but all logs
