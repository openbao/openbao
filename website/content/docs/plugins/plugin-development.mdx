...
it easy for you to build a OpenBao plugin for your organization's internal use,
...
~> Plugin multiplexing requires `github.com/lf-edge/openbao/sdk v0.5.4` or above.

The following code exhibits an example main package for a OpenBao plugin using
...
[`RunningVersion`](https://github.com/lf-edge/openbao/blob/sdk/v0.6.0/sdk/framework/backend.go#L95-L96)
...
See the [OpenBao Integrations](/vault/integrations) page to find Community
