---
layout: docs
page_title: OpenBao Auto-Auth AliCloud Method
description: AliCloud Method for OpenBao Auto-Auth
---

# OpenBao agent Auto-Auth AliCloud method
...
- `region` `(string: required)` - The AliCloud region in which the OpenBao agent resides. Example: "us-west-1".

- `credential_poll_interval` `(integer: optional)` - In seconds, how frequently the OpenBao agent should check for new credentials.
