---
layout: docs
page_title: OpenBao Auto-Auth AppRole Method
...
An example configuration, using approle to enable [auto-auth](/docs/agent-and-proxy/autoauth)
and creating both a plaintext token sink and a [response-wrapped token sink file](/docs/agent-and-proxy/autoauth#wrap_ttl), follows:
