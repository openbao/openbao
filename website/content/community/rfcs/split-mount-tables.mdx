...
More precisely, we have the following places where the mount table is potentially adjusted:
 ...
 - When [mounting](/docs/api/system/mounts/#enable-secrets-engine) a new secrets engine.
 - When [tuning](/docs/api/system/mounts/#tune-mount-configuration) a secrets engine.
