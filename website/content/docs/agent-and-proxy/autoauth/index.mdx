---
layout: docs
page_title: OpenBao Agent and OpenBao Proxy Auto-Auth
description: |-
...
at the
[dhutil](https://github.com/lf-edge/openbao/blob/main/helper/dhutil/dhutil.go)
...
- `wrap_ttl` `(string or integer: optional)` - If specified, the written token
  ...
  [SecretWrapInfo](https://godoc.org/github.com/lf-edge/openbao/api#SecretWrapInfo)
