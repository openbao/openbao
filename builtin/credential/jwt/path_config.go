	...
	return &framework.Path{
		...
		Fields: map[string]*framework.FieldSchema{
			...
			"skip_jwks_validation": {
				Type:        framework.TypeBool,
				Description: "When true and oidc_discovery_url or jwks_url are specified, if the connection fails to load, a warning will be issued and status can be checked latery by the /config/validate endpoint.",
			},
		},
