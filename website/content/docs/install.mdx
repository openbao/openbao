...
- [Day One Preperation](/tutorials/day-one-raft) 
- [Recommended Patterns](/tutorials/recommended-patterns)


[learn-vault-install]: /tutorials/getting-started/getting-started-install
[learn-vault-dev-server]: /tutorials/getting-started/getting-started-dev-server
