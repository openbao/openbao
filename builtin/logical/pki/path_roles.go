...
func (b *backend) pathRoleCreate(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	...
	entry := &roleEntry{
		...
		AllowWildcardsInSubstitutions: data.Get("allow_wildcards_in_substitutions").(bool),
...
func (b *backend) pathRolePatch(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	...
	entry := &roleEntry{
		...
		AllowWildcardsInSubstitutions: data.GetWithExplicitDefault("allow_wildcards_in_substitutions", oldEntry.AllowWildcardsInSubstitutions).(bool),
...
type roleEntry struct {
	...
	AllowWildcardsInSubstitutions bool          `json:"allow_wildcards_in_substitutions"`
...
func (r *roleEntry) ToResponseData() map[string]interface{} {
	...
	responseData := map[string]interface{}{
		...
		"allow_wildcards_in_substitutions":   r.AllowWildcardsInSubstitutions,
