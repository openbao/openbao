...
description: |-
  ...
  snapshots with OpenBao's Raft storage backend.
---
...
- `file_prefix` `(string: "openbao-snapshot")` - Within the directory or bucket
...
```json
{
  "interval": "24h",
  "retain": 7,
  "path_prefix": "/opt/openbao/snapshots/",
  "storage_type": "local",
...
```json
{
  "data": {
    ...
    "last_snapshot_url": "file:///opt/openbao/snapshots/openbao-snapshot-1603898241699731000.snap",
    "snapshot_start": "2020-10-28T11:17:21-04:00",
    "snapshot_url": "file:///opt/openbao/snapshots/openbao-snapshot-1603898241699731000.snap"
  }
}
```
