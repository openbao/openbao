...
The usage of `provider: openbao` is only working starting with the OpenBao Helm Chart version 0.18.0, which uses the OpenBao CSI Provider version 2.0.0 or later.
