...
> Refer to the [OpenBao Usage Metrics](/vault/tutorials/monitoring/usage-metrics) tutorial to learn more about usage metrics,
...
```shell-session
$ openbao operator usage -start-time=2020-01 -end-time=2020-01
