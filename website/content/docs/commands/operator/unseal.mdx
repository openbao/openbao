...
description: |-
  ...
  to unseal a OpenBao server.
---

# operator unseal

The `operator unseal` allows the user to provide a portion of the root key to
unseal a OpenBao server. OpenBao starts in a sealed state. It cannot perform
...
```shell-session
$ openbao operator unseal IXyR0OJnSFobekZMMCKCoVEpT7wI6l+USMzE3IcyDyo=
```
